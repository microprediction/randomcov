...
Curiosity led us to wonder if the same brittleness of claim might apply more broadly, or whether, to put a more positive spin on the topic, there may be many opportunities to identify improvements to existing tools. Our methodology is very simple and short here. We take a published claim, re-run its demonstration using every type of covariance generator at our disposal, and report the verdict. If anything the selection was biased towards things we either knew to be helpful or hoped would be -- what that means for how the results should be read is taken up properly in Scope below.
...
The audits measure the ensemble-sensitivity of a claim, often outside the careful scope of the authors' original intent.
